...
class LineYPainter extends BasePainter {
  ...
  @override
  bool shouldRepaint(LineYPainter oldDelegate) {
    return true;
  }
  ...
  void _initValue() {
    xColor ??= BaseThemeConfig.instance.getConfig().commonConfig.colorTextBase;
    yColor ??=
        BaseThemeConfig.instance.getConfig().commonConfig.colorTextSecondary;
    hintLineColor ??=
