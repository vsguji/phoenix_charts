 ...
 * @LastEditTime: 2023-09-24 20:33:27
 * @FilePath: /phoenix_charts/lib/broken_line/broken_line.dart
...
class BrokenLine extends StatefulWidget {
  ...
  /// y轴左侧刻度显示，不传则没有
  final List<DialItem>? yDialValues;

  /// x 轴刻度
  final List<DialItem>? xDialValues;
  ...
  @override
  State<StatefulWidget> createState() => BrokenLineState();
}

class BrokenLineState extends State<BrokenLine> {
  int pointSelectIndex = -1;
  int lineSelectIndex = -1;

  @override
  Widget build(BuildContext context) {
    var _lineWithXPainter = LinePainter(
      widget.lines,
  ...
  Widget _buildTouchTipWidget(PointData pointData) {
    Widget touchTipWidget;
    LineTouchData? selectLinePoint = pointData.lineTouchData;
