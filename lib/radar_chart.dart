...
class RadarChart extends MultiChildRenderObjectWidget {
...
class RadarChartParentData extends ContainerBoxParentData<RenderBox> {}
...
class RenderRadarChart extends RenderBox
    with
        ContainerRenderObjectMixin<RenderBox, RadarChartParentData>,
        RenderBoxContainerDefaultsMixin<RenderBox, RadarChartParentData> {
  Paint _radarPainter;
  Paint _axisPainter;
  ...
  void setupParentData(RenderBox child) {
    if (child.parentData is! RadarChartParentData) {
      child.parentData = RadarChartParentData();
    }
  }
  ...
  double _getIntrinsicDimensionHorizontal(
    ...
    int i = 0;
    while (child != null) {
      final RadarChartParentData childParentData =
          child.parentData as RadarChartParentData;
  ...
  void _drawRadar(Canvas canvas) {
    ...
    for (int radarIndex = 0; radarIndex < radarCount; radarIndex++) {
      RadarChartStyle radarStyle = _dataProvider.getRadarStyle(radarIndex);
      _radarPainter
        ..isAntiAlias = true
